...
**The wikipedia dataset**(Politicians by Country from the English-language Wikipedia) [Terms & Conditions](https://figshare.com/terms)
...
See [https://ores.wikimedia.org](See https://ores.wikimedia.org) for more information on how to use the API.
...
* "Location", containing
* "Location Type", containing
* "TimeFrame", containing
